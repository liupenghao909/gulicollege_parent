...
import com.ant.springSecurity.entity.SecurityUser;
 ...
 *
 * 对应spring security模块中的UserDetailsService
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // 返回UserDetails实现类
        com.ant.springSecurity.entity.User curUser = new com.ant.springSecurity.entity.User();
